  ...
  head: () => ({
    meta: [
      { title: "YasRose — زهور فاخرة تُصمم لحظاتك" },
      {
        name: "description",
        content:
          "دار زهور فاخرة في بني سويف. باقات مُنسقة يدوياً، علب هدايا حصرية، وتوصيل في نفس اليوم.",
      },
    ...
    <section className="py-24">
      <div className="container-luxe">
        <div className="reveal relative overflow-hidden rounded-[40px] bg-charcoal text-primary-foreground px-8 py-16 md:p-20">
          <div
            className="absolute -top-32 -right-32 w-[480px] h-[480px] rounded-full bg-rose-gold/25 blur-3xl"
            aria-hidden
          />
          <div
            className="absolute -bottom-40 -left-24 w-[420px] h-[420px] rounded-full bg-blush/15 blur-3xl"
            aria-hidden
          />
          <div className="relative grid lg:grid-cols-[1.2fr_1fr] items-center gap-12">
            <div>
              ...
              <p className="mt-6 text-primary-foreground/70 leading-loose max-w-lg">
                دع YasRose AI يرشح لك أجمل الباقات بناءً على المناسبة، الأسلوب، والألوان التي
                تفضلها. تجربة شخصية في أقل من دقيقة.
              </p>
              <div className="mt-10 flex flex-wrap items-center gap-4">
                <button
                  onClick={onOpen}
                  className="btn-luxe !bg-rose-gold !text-white hover:!bg-rose-gold/90"
                >
                  <Sparkles className="w-4 h-4" /> جرّب توصية الذكاء الاصطناعي
                </button>
                <div className="text-xs tracking-[0.2em] text-primary-foreground/60">
                  مجاناً · بدون تسجيل
                </div>
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="glass rounded-3xl p-6 bg-white/5 border-white/10 backdrop-blur-xl">
                ...
                <div className="space-y-3 text-sm">
                  <div className="p-3 rounded-2xl bg-white/10 rounded-tr-sm">
                    لمن تُهدي الزهور اليوم؟
                  </div>
                  <div className="p-3 rounded-2xl bg-rose-gold/90 text-white rounded-tl-sm w-fit ms-auto">
                    لأمي، بمناسبة عيد الأم 🌸
                  </div>
                  <div className="p-3 rounded-2xl bg-white/10 rounded-tr-sm">
                    اختيار جميل. أقترح باقة فاوانيا وردية بأسلوب رومانسي...
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="container-luxe">
        <div className="relative overflow-hidden rounded-[40px] bg-blush/60 px-8 py-16 md:p-20">
          <div
            ...
            style={{
              backgroundImage: `url(${IMG.flatlay})`,
          ...
          <div className="relative grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-charcoal/70 leading-loose max-w-md">
                اختر الزهور، الألوان، التغليف، والإضافات. شاهد باقتك تتشكل أمامك مباشرة، بلمسة صانع
                محترف.
              </p>
              <div className="mt-10 flex flex-wrap items-center gap-4">
                ...
                <div className="text-xs tracking-[0.2em] text-charcoal/60">
                  معاينة مباشرة · تجربة تفاعلية
                </div>
              </div>
            </div>
            <div className="grid grid-cols-3 gap-3">
              {[IMG.hero, IMG.b2, IMG.b4, IMG.b1, IMG.b3, IMG.flatlay].map((src, i) => (
                <div
                  key={i}
                  className={`overflow-hidden rounded-2xl ${i === 0 ? "col-span-2 row-span-2 aspect-square" : "aspect-square"}`}
                >
                  <img
                    src={src}
                    alt=""
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(30,22,18,0.78) 0%, rgba(30,22,18,0.35) 45%, rgba(30,22,18,0.08) 100%)",
        }}
        aria-hidden
      />
      <div
        className="absolute inset-0"
        style={{ background: "linear-gradient(to right, rgba(30,22,18,0.35) 0%, transparent 55%)" }}
        aria-hidden
      />
        ...
        <div ref={contentRef} className="max-w-2xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[10px] tracking-[0.35em] text-white/50 uppercase">
              YasRose · Beni Suef · 2026
            </span>
          </div>

          {/* Headline */}
          <h1 style={{ ...CORMORANT, lineHeight: 1, letterSpacing: "-0.01em" }}>
            <span className="block text-white text-[clamp(2.8rem,7vw,6rem)]">زهور تُروى</span>
            <span
          ...
          {/* Sub */}
          <p
            className="mt-5 text-white/55 leading-relaxed max-w-sm"
            style={{ ...CORMORANT, fontSize: "clamp(1rem,2vw,1.2rem)" }}
          >
          ...
          <div className="mt-10 pt-8 border-t border-white/10 flex items-center gap-8 flex-wrap">
            {[
              ...
              <div key={l}>
                <div style={{ ...CORMORANT, fontSize: "1.6rem", color: "white", lineHeight: 1 }}>
                  {n}
                </div>
                <div
      ...
      >
        <div
          ...
          style={{ animation: "grow-line 2s ease-in-out infinite" }}
        />
      </div>
    </section>
  );
      ...
      <div className="py-3.5 border-b border-border/40">
        <div className="flex gap-14 animate-marquee whitespace-nowrap">
          {[...row1, ...row1, ...row1].map((t, i) => (
            <span
              key={i}
              className="text-[11px] tracking-[0.28em] uppercase text-muted-foreground flex items-center gap-14"
            >
      ...
      <div className="py-3.5 bg-blush/15">
        <div className="flex gap-14 animate-marquee-rev whitespace-nowrap">
          {[...row2, ...row2, ...row2].map((t, i) => (
            <span
              key={i}
              className="text-[11px] tracking-[0.28em] uppercase text-rose-gold/70 flex items-center gap-14"
            >
              <span className="text-sm">{t.icon}</span> {t.text}
  ...
  return (
    <section className="py-32 container-luxe">
      <div className="reveal flex items-end justify-between gap-8 mb-10 flex-wrap">
        ...
        <Link to="/shop" className="btn-ghost-luxe shrink-0">
          عرض المجموعة كاملة
        </Link>
      </div>
      ...
      <div className="container-luxe">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-5 text-muted-foreground leading-loose">
            من الأعراس إلى المكاتب، تجد عندنا الباقة التي تعبّر عنك بالضبط.
          </p>
        </div>
                ...
                return cat ? (
                  <div className="animate-fade-in-up">
                    ...
                    <div className="text-sm text-muted-foreground mt-1">
                      {cat.count} تصميم متاح في هذه الفئة
                    </div>
                  </div>
                ) : null;
              })()}
          ...
          {categories.map((c) => (
            ...
            >
              ...
              <div className="mt-3.5 flex items-baseline justify-between gap-2">
                <div className="font-display text-base group-hover:text-rose-gold transition">
                  {c.name}
                </div>
  ...
  const items = [
    {
      ...
      desc: "نستورد أفضل الأنواع من هولندا وإكوادور، ونستلمها كل صباح.",
      stat: "٩٨٪",
    ...
    },
    {
      icon: HandHeart,
      title: "تنسيق يدوي",
      desc: "كل باقة تُصمم يدوياً في أتلييه بني سويف على يد مصممين محترفين.",
      stat: "+٨",
      statLabel: "مصمم متخصص",
    },
    {
      icon: Truck,
      title: "توصيل في نفس اليوم",
      desc: "خدمة توصيل فاخرة تصل باقتك في الوقت المحدد بالضبط.",
      stat: "٣ س",
      statLabel: "متوسط وقت التوصيل",
    },
    {
      icon: Sparkles,
      title: "لمسة استثنائية",
      desc: "بطاقة إهداء مكتوبة يدوياً وتغليف فاخر مع كل طلب.",
      stat: "١٠٠٪",
      statLabel: "تغليف مخصص يدوي",
    },
  ];
  return (
      ...
      <div className="container-luxe">
        <div className="grid lg:grid-cols-[1fr_1.4fr] gap-16 items-start mb-20">
          ...
          <p className="text-primary-foreground/70 leading-loose text-lg self-end">
            في YasRose، لا نصمم باقات فحسب — بل نصمم لحظات. من اختيار الزهرة إلى ربطة الشريط، كل
            تفصيل يُدرس بعناية ليكون تجربة استثنائية تليق بمن تُحب.
          </p>
        </div>
        <div className="stagger-children grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {items.map((it, i) => (
            <div
              key={it.title}
              className="group relative bg-white/5 hover:bg-white/8 border border-white/10 hover:border-rose-gold/40 rounded-3xl p-8 transition-all duration-500 card-hover overflow-hidden"
            >
              <div
                className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-rose-gold/10 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                aria-hidden
              />
...
function Reviews() {
  const reviews = [
    {
      name: "لمى العتيبي",
      text: "أجمل باقة استلمتها في حياتي. التغليف بحد ذاته تحفة، والزهور طازجة كأنها للتو من الحديقة.",
      city: "بني سويف",
      product: "لوميير روز",
      avatar: "ل",
    },
    {
      name: "نور الحربي",
      text: "YasRose أصبح خياري الأول لكل مناسبة. التفاصيل، الذوق، والالتزام بالوقت شيء استثنائي.",
      city: "القاهرة",
      product: "روز أتلييه • علبة",
      avatar: "ن",
    },
    {
      name: "دانة الشمري",
      text: "طلبت علبة توقيع الدار هدية، ودموع الفرح قالت كل شيء. شكراً على اللمسة الراقية.",
      city: "أسيوط",
      product: "فالينوبسيس سولو",
      avatar: "د",
    },
    {
      name: "ريم القحطاني",
      text: "تجربة كاملة من أول لحظة للطلب حتى وصول الباقة. التغليف فاخر جداً وكأنه هدية من محل راقٍ في باريس.",
      city: "بني سويف",
      product: "إيفوار جاردن",
      avatar: "ر",
    },
    {
      name: "هند الزهراني",
      text: "أرسلت لأمي باقة في عيد الأم وكانت المفاجأة مذهلة. رائحة الزهور ملأت البيت كله. شكراً YasRose.",
      city: "الإسكندرية",
      product: "لوميير روز",
      avatar: "ه",
    },
        ...
        <div className="flex items-end justify-between gap-8 mb-16 flex-wrap">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={prev}
              aria-label="السابق"
              className="w-10 h-10 grid place-items-center rounded-full border border-border hover:border-rose-gold hover:text-rose-gold transition"
            >
          ...
          {visible.map((r, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <Quote
                  className={`w-8 h-8 opacity-20 ${i === 0 ? "text-rose-gold" : "text-charcoal"}`}
                />
              </div>
              ...
              <figcaption
                className={`mt-8 pt-6 border-t flex items-center gap-3 ${i === 0 ? "border-white/10" : "border-border/60"}`}
              >
                ...
                <div>
                  <div
                    className={`font-medium text-sm ${i === 0 ? "text-primary-foreground" : ""}`}
                  >
                    {r.name}
                  </div>
                  <div
                    className={`text-xs flex items-center gap-1 mt-0.5 ${i === 0 ? "text-primary-foreground/50" : "text-muted-foreground"}`}
                  >
                    <MapPin className="w-3 h-3" /> {r.city}
                  </div>
                </div>
                <div
                  className={`ms-auto text-[10px] tracking-[0.2em] uppercase ${i === 0 ? "text-rose-gold" : "text-rose-gold/70"}`}
                >
                  موثقة
                </div>
              </figcaption>
        ...
        <div className="relative overflow-hidden rounded-[40px] bg-cream border border-border/40">
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-0">
            ...
            <div className="relative aspect-[4/3] lg:aspect-auto overflow-hidden rounded-tr-[40px] rounded-br-[40px] lg:rounded-tr-none lg:rounded-br-none rounded-tl-[40px] rounded-bl-[40px]">
              ...
              <div
                className="absolute inset-0 bg-gradient-to-l from-cream/60 via-transparent to-transparent hidden lg:block"
                aria-hidden
              />
              <div className="absolute bottom-6 left-6 card-glass rounded-2xl px-5 py-4 shadow-soft">
                <div className="text-[10px] tracking-[0.2em] uppercase text-rose-gold mb-1">
                  تأسس عام
                </div>
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center">
              ...
              <p className="mt-6 text-muted-foreground leading-loose max-w-lg">
                في قلب بني سويف، يعمل فريق مصممين محترفين كل يوم منذ الفجر على انتقاء أجمل الزهور
                واحدةً واحدة، لتُولد كل باقة من أنامل تُحب ما تصنع.
              </p>
...
function DeliveryBanner() {
  const features = [
    {
      icon: Clock,
      title: "توصيل في ٣ ساعات",
      desc: "نضمن وصول طلبك خلال ٣ ساعات داخل بني سويف بعد تأكيد الطلب.",
    },
    {
      icon: MapPin,
      title: "التغطية الجغرافية",
      desc: "نُوصّل للقاهرة، المنصورة، ومناطق أخرى — اطّلع على الخريطة.",
    },
    {
      icon: PhoneCall,
      title: "تأكيد مباشر",
      desc: "سيتصل بك فريق الدار لتأكيد الموعد المثالي قبل المغادرة.",
    },
    {
      icon: Sparkles,
      title: "تغليف احترافي",
      desc: "كل طلب يصل في صندوق YasRose المُعبّأ يدوياً بعطر الدار.",
    },
  ];
  return (
      ...
      <div className="container-luxe">
        ...
        <div className="stagger-children grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((f, i) => (
            <div
              key={i}
              className="group bg-background border border-border/60 rounded-3xl p-8 card-hover"
            >
    ...
    <section className="py-24">
      <div className="container-luxe">
        <div className="relative overflow-hidden rounded-[40px] bg-charcoal text-primary-foreground px-8 py-20 md:p-24">
          ...
          />
          <div
            className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-rose-gold/20 blur-3xl"
            aria-hidden
          />
          <div
            className="absolute -bottom-32 -left-24 w-[400px] h-[400px] rounded-full bg-blush/10 blur-3xl"
            aria-hidden
          />
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {["لا رسائل مزعجة", "إلغاء في أي وقت", "محتوى حصري"].map((t) => (
                  <span
                    key={t}
                    className="text-xs border border-white/20 rounded-full px-3 py-1 text-primary-foreground/70"
                  >
                    {t}
                  </span>
                ))}
              ...
              {sent ? (
                <div className="card-glass rounded-3xl p-10 text-center">
                  ...
                  <div className="text-sm text-muted-foreground">
                    سنرسل لك أجمل الأخبار والمفاجآت.
                  </div>
                </div>
              ) : (
